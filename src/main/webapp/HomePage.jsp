...
<body>
	...
	<section class="hero">
		...
		<div class="container">
			<div class="hero-content">
				...
				<p class="lead">Hành trình tuyệt vời cùng nắng vàng, biển xanh
					và cát trắng</p>
				...
				<form action="${pageContext.request.contextPath}/TourListServlet"
					...
					<div class="input-group">
						<input type="text" name="destination"
							placeholder="Đi đâu? (Phú Quốc, Nha Trang...)"> <input
	...
	<section class="promo">
		<div class="container">
			<h2 class="section-title text-center">
				Khuyến Mãi <span class="highlight">Hot</span> Trong Tuần
			</h2>
			<div class="promo-grid">
				<div class="promo-card">
					...
					<div class="promo-info">
						...
						<p class="countdown">
							<i class="fas fa-clock"></i> Còn 2 ngày
						</p>
				...
				<div class="promo-card">
					...
					<div class="promo-info">
						...
						<p class="countdown text-danger">
							<i class="fas fa-exclamation-triangle"></i> Sắp hết chỗ!
						</p>
	...
	<section class="why-choose py-5">
		<div class="container">
			<h2 class="section-title text-center">
				Tại Sao Chọn <span class="highlight">Việt Nam Travel</span>?
			</h2>
			<div class="features-grid">
				<div class="feature-item">
					...
					<h3>Giá Tốt Nhất</h3>
					<p>Cam kết giá cạnh tranh, không phí ẩn. So sánh để thấy sự
						khác biệt!</p>
				</div>
				<div class="feature-item">
					<div class="icon">
					...
					<h3>Hỗ Trợ 24/7</h3>
					<p>Tư vấn miễn phí trước, trong và sau chuyến đi. Luôn sẵn
						sàng!</p>
				</div>
				<div class="feature-item">
					<div class="icon">
					...
					<p>Đội ngũ HDV giàu kinh nghiệm, nhiệt tình, am hiểu địa
						phương.</p>
				</div>
				<div class="feature-item">
					<div class="icon">
